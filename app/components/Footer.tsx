    ...
    <footer className="bg-green-900 text-white pt-12 pb-6">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-xl font-semibold mb-4">গণস্বাস্থ্য হোমিও</h3>
            <p className="text-green-100 mb-4">
              আমরা বাংলাদেশের সর্বাধিক অভিজ্ঞ হোমিওপ্যাথিক চিকিৎসা কেন্দ্র।
              আমাদের লক্ষ্য মানুষের স্বাস্থ্য সেবা নিশ্চিত করা।
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-green-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-green-200">
              &copy; {new Date().getFullYear()} গণস্বাস্থ্য হোমিও। সর্বস্বত্ব
              সংরক্ষিত।
            </p>
